...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Hayato Arai \vspace{2pt}} & % row = 1, col = 1
  ...
  \href{https://github.com/aralsea}{\uline{GitHub}} $|$ % row = 2, col = 1
  \href{https://atcoder.jp/users/aralsea}{\uline{Atcoder}} & % row = 2, col = 1
  Email: \href{mailto:arai828hayato@gmail.com}{\uline{arai828hayato@gmail.com}} $|$ % row = 2, col = 2
  Mobile: +81 080-8230-9602 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
